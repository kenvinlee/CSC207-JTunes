...
public class Playlist {
	...
	//finds the song's position in playlist
	...
	//checks to see if song exists in playlist
	...
	//puts all the songs by artist into one playlist so you can play only songs by 1 artist
	public Playlist sortByArtist(Song s)
	{
		...
		for (int i = 0; i < songsInPlaylist.size(); i++)
		{
			...
			{
				byArtist.playlistAddSong(songsInPlaylist.get(i));
			}
		}
	...
	//string rep of playlist
	public String toString()
	{
		return this.name;
	}

	//sets a playlist to library's main
	public void setMain()
	{
		this.mainPlaylist = true;
	}

	//Checks if playlist is library's main playlist
