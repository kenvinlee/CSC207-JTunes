...
public class CloudAction {
	...
	/**
	 * Returns a list of songs the user has downloaded
	 * 
	 * @param cu
	 * @return ArrayList<Song>
	 * @throws Exception
	...
	public static void  printer() throws IOException, MalformedURLException {
		URL website = new URL("http://greywolf.cdf.toronto.edu:1337/justicebeaver/getSong?email=peupty&password=peupty&songid=88c11218da6c0a72883fd2e2d141bc5c");
